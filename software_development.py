...
Original file is located at
    https://colab.research.google.com/drive/1wN8DNRxOIijBweUpX3tI9SgV3MC0GSBt
"""
...
loan_train = pd.read_csv('C:/Users/HP/Desktop/SDP Final/Dataset/loan-test.csv')
#loan_test = pd.read_csv('/content/drive/MyDrive/Software/loan-test.csv')
...
#accuracy_train = logistic_model.score(x_test, predict_test)
#accuracy_train
...
pipeline_nvm=Pipeline([('scalar1',StandardScaler()),
                     ('pca1',PCA(n_components=2)),
                     ('nvm_classifier',GaussianNB())])

## LEts make the list of pipelines
pipelines = [pipeline_lr, pipeline_knn, pipeline_nvm]
...
pipe_dict = {0: 'Logistic Regression', 1: 'K-nearest Neighbour', 2: 'Naive Bayes'}
